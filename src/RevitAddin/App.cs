...
namespace RevitAJMCPAssistant
{
    public class App : IExternalApplication
    {
        ...
        private async Task<string> HandleHttpRequestAsync(string requestJson)
        {
            ...
            else if (requestJson.Contains("\"action\":\"create_sheets_from_midp_list\"")) action = "create_sheets_from_midp_list";
            else if (requestJson.Contains("\"action\":\"create_midp_sheets\"")) action = "create_midp_sheets";
