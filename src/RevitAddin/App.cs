...
namespace RevitAJMCPAssistant
{
    public class App : IExternalApplication
    {
        ...
        {
            string action = "ping";
            if (requestJson.Contains("\"action\":\"get_document_info\""))
            {
                action = "get_document_info";
            }
            else if (requestJson.Contains("\"action\":\"create_wall\""))
            {
                action = "create_wall";
            }
            else if (requestJson.Contains("\"action\":\"list_sheets\""))
            {
                action = "list_sheets";
            }
            else if (requestJson.Contains("\"action\":\"create_sheet\""))
            {
                action = "create_sheet";
            }
